...
std::string vectorToTxtFile(std::vector<double> data){
  std::string fileName = "/mit/barragan/Documents/cppCode/basicBayesV2wComm/files/bbToRobot.txt";
...
bool getResponse(std::vector<double> &dataVec){
  std::string receivedFile = "/mit/barragan/Documents/cppCode/basicBayesV2wComm/files/robotToBB.txt";
