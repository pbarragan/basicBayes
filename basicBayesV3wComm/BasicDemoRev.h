...
*/
#ifndef BASIC_DEMO_REV_H
#define BASIC_DEMO_REV_H
...
class BasicDemoRev
{
 public:
  ...
  btHingeConstraint* hingeConstraint_; //this is the constraint between the fixed point and the rotating beam
  btHingeConstraint* hingeConstraint2_; //this is the constraint between the rotating beam and the robot hand
