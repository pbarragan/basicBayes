...
std::string vectorToTxtFile(std::vector<double> data){
  ...
  std::string fileName = "/mit/barragan/Documents/cppCode/basicBayesV3wComm/files/bbToRobot.txt";
...
bool getResponse(std::vector<double> &dataVec){
  //this needs to get changed if you are using a different basicBayes package
  std::string receivedFile = "/mit/barragan/Documents/cppCode/basicBayesV3wComm/files/robotToBB.txt";
